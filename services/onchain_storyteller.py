...
def _build_prompt(ctx: dict) -> str:
    ...
    return (
        ...
        "   LTH-SOPR varsa ve 1.0'ın üstündeyse 'uzun vadeciler kontrollü "
        "   dağıtımda — tepe değil, kademeli kar realizasyonu' nuansını ver "
        "   (2.0 üstüyse 'tepe uyarı bölgesi' diye uyar).\n"
        ...
        "   bekleniyor' diye işle. Korean Premium negatifse 'Asya tarafı henüz "
        "   teyit etmedi — Upbit primi sıfırı geçince ralli onayı tamamlanır' "
        "   gibi bir koşul ekleyebilirsin.\n"
        ...
        "- LTH-SOPR → 'uzun vadeci kâr katsayısı'\n"
