...
def _cpi_prompt(llm_input: dict, tier: Tier) -> str:
    ...
    return (
        ...
        "5. Yatırım tavsiyesi YASAK ('şimdi al', 'şimdi sat'). 'Senin için 1-cümle' "
        "bölümü ZORUNLU ve MUTLAKA belirgin bir YÖN içermeli — şu kelimelerden "
        "en az birini kullan: şahin/hawkish, güvercin/dovish, BTC pozitif/yukarı/destek, "
        "BTC baskı/aşağı/satış, USD güçlü/yukarı, USD zayıf/baskı, enflasyon yukarı/artış, "
        "enflasyon aşağı/yavaşlama/gerile, risk-on/riski alış, risk-off/savunmacı. "
        "Sadece bilgilendirici/nötr ('temel referans noktası', 'şekillendirebilir', "
        "'önemli ipuçları') YETERLİ DEĞİL — okuyan kişi yönü net çıkarabilmeli.\n"
